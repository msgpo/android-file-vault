...
//  This code borrowed from Camera 2 google sample under the terms of Apache 2 license
//  See https://github.com/googlesamples/android-Camera2Basic
//  The original licensing and terms follow:
/*
        ...
        try {
            ...
            val captureCallback = object : CameraCaptureSession.CaptureCallback() {
                ...
                override fun onCaptureCompleted(session: CameraCaptureSession,
                                                request: CaptureRequest,
                                                result: TotalCaptureResult) {
                    Log.d(TAG, "Completed capture of image")
                    unlockFocus()
                }
            }
